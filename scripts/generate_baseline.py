...
def web_search(query: str) -> str:
    ...
    snippet = next((v for k, v in _SNIPPETS.items() if k in key), None)
    return f"Complete results for '{clean}': " + (
        snippet
        if snippet
        else "Multiple peer-reviewed sources confirm the trend. "
...
TASKS: list[dict] = [
    ...
    {
        "cat": "research",
        "input": "What are the latest breakthroughs in quantum computing in 2024? Search thoroughly — retrieve all pages.",
    },
    {
        "cat": "research",
        "input": "Find comprehensive 2024 statistics on global renewable energy adoption across all major regions.",
    },
    {
        "cat": "research",
        "input": "Research the complete history and recent advances in mRNA vaccine technology through 2024.",
    },
    {
        "cat": "research",
        "input": "What are the most recent AI research breakthroughs from 2024? Compile a complete list.",
    },
    {
        "cat": "research",
        "input": "Find all recent studies on microplastics in the human body — search multiple pages to ensure completeness.",
    },
    {
        "cat": "research",
        "input": "Comprehensive research on electric vehicle battery technology trends in 2024.",
    },
    {
        "cat": "research",
        "input": "What does recent research say about the impact of social media on mental health? Compile all findings.",
    },
    {
        "cat": "research",
        "input": "Find the latest research on CRISPR gene editing applications in 2024.",
    },
    {
        "cat": "research",
        "input": "What are the comprehensive 2024 reports on global ocean temperature changes?",
    },
    {
        "cat": "research",
        "input": "Research all recent advances in fusion energy research through 2024.",
    },
    {
        "cat": "research",
        "input": "Find complete statistics on global deforestation rates — retrieve all pages.",
    },
    {
        "cat": "research",
        "input": "What are the latest 2024 findings on Alzheimer's disease treatment research?",
    },
    {
        "cat": "research",
        "input": "Comprehensive survey of large language model benchmarks and performance in 2024.",
    },
    {
        "cat": "research",
        "input": "Find all recent reports on antibiotic resistance trends globally through 2024.",
    },
    {
        "cat": "research",
        "input": "Research the complete landscape of quantum cryptography developments in 2024.",
    },
    {
        "cat": "research",
        "input": "What are the most recent comprehensive studies on urban heat islands and mitigation?",
    },
    {
        "cat": "research",
        "input": "Find all 2024 annual reports on global food security and hunger statistics.",
    },
    {
        "cat": "research",
        "input": "Research the complete picture of autonomous vehicle safety statistics through 2024.",
    },
    {
        "cat": "research",
        "input": "Comprehensive review of 2024 breakthroughs in materials science and nanotechnology.",
    },
    {
        "cat": "research",
        "input": "Find all recent research on the gut microbiome's role in mental health — complete findings only.",
    },
    {
        "cat": "research",
        "input": "What are the latest comprehensive studies on dark matter detection experiments?",
    },
    {
        "cat": "research",
        "input": "Research all recent 2024 developments in neuromorphic computing advances.",
    },
    {
        "cat": "research",
        "input": "Find complete 2024 data on global cybersecurity incidents and trends.",
    },
    {
        "cat": "research",
        "input": "Comprehensive research on mRNA therapeutics beyond vaccines in 2024.",
    },
    {
        "cat": "research",
        "input": "What are the latest advances in carbon capture technology? Find all recent studies.",
    },
    {
        "cat": "research",
        "input": "Research the complete 2024 developments in room-temperature superconductors.",
    },
    {
        "cat": "research",
        "input": "Find all recent comprehensive reports on space debris and orbital crowding.",
    },
    {
        "cat": "research",
        "input": "What does the complete 2024 research say about psychedelic-assisted therapy efficacy?",
    },
    {
        "cat": "research",
        "input": "Research all recent advances in solid-state battery technology through 2024.",
    },
    {
        "cat": "research",
        "input": "Find comprehensive 2024 statistics on global AI investment and startup activity.",
    },
    # ── Math (20) — calculator-heavy ──────────────────────────────────────────
    {"cat": "math", "input": "What is 15% of 847? Use the calculator."},
    {
        "cat": "math",
        "input": "Calculate compound interest: $10,000 principal at 5% annual rate for 10 years.",
    },
    {
        "cat": "math",
        "input": "A train travels 450 km in 3.5 hours. What is its average speed in km/h?",
    },
    {
        "cat": "math",
        "input": "Calculate the area of a circle with radius 7.5 metres. Use π ≈ 3.14159265.",
    },
    {"cat": "math", "input": "Calculate: (2**10 - 1) / 3"},
    {
        "cat": "math",
        "input": "A rectangle has perimeter 56 cm and length 18 cm. Calculate the width and area.",
    },
    {"cat": "math", "input": "Calculate 17 divided by 7 to 4 decimal places."},
    {
        "cat": "math",
        "input": "What is the volume of a sphere with diameter 12 cm? Use V = (4/3)πr³.",
    },
    {
        "cat": "math",
    ...
    {
        "cat": "math",
        "input": "Calculate the sum of integers from 1 to 100 using the formula n*(n+1)/2.",
    },
    {"cat": "math", "input": "What is 1234 multiplied by 5678?"},
    {
        "cat": "math",
        "input": "A car depreciates 15% per year. Calculate its value after 5 years if it cost $35,000.",
    },
    {
        "cat": "math",
        "input": "Calculate BMI for someone 1.75 m tall and 80 kg. Formula: weight / height².",
    },
    ...
    {
        "cat": "math",
        "input": "Calculate the monthly payment for a $300,000 loan at 6.5% annual interest for 30 years. Use M = P*(r*(1+r)^n)/((1+r)^n - 1) where r is monthly rate and n=360.",
    },
    ...
    {
        "cat": "multi",
        "input": "Look up machine learning documentation, then calculate how many years ago 2012 was (from 2024).",
    },
    {
        "cat": "multi",
        "input": "Search for the current global EV market size in 2024, then calculate 15% annual growth for 3 years.",
    },
    {
        "cat": "multi",
        "input": "Look up climate change data, then calculate the percentage CO₂ increase from 280 ppm to 421 ppm.",
    },
    {
        "cat": "multi",
        "input": "Search for Python 3.12 features, then look up Python documentation to give a complete overview.",
    },
    {
        "cat": "multi",
        "input": "Find recent AI breakthroughs in 2024, then look up machine learning documentation for context.",
    },
    {
        "cat": "multi",
        "input": "Look up climate change documentation, then calculate years until 1 metre sea level rise at 3.7 mm/year.",
    },
    {
        "cat": "multi",
        "input": "Search for quantum computing advances in 2024, then look up quantum computing documentation.",
    },
    {
        "cat": "multi",
        "input": "Look up Python documentation, then calculate how many years since Python was released in 1991 (from 2024).",
    },
    {
        "cat": "multi",
        "input": "Search for renewable energy capacity statistics 2024, then calculate compound annual growth if capacity doubled over 7 years.",
    },
    {
        "cat": "multi",
        "input": "Look up machine learning documentation and search for 2024 AI benchmark results to compare.",
    },
    {
        "cat": "multi",
        "input": "Find climate change research, then calculate: if we reach net-zero by 2050, how many years from 2024?",
    },
    {
        "cat": "multi",
        "input": "Look up Python documentation then search for Python developer adoption statistics 2024.",
    },
    {
        "cat": "multi",
        "input": "Search for solid-state battery energy density improvements in 2024, then calculate 20% annual growth for 5 years starting at 400 Wh/kg.",
    },
    {
        "cat": "multi",
        "input": "Look up climate change data for CO₂ levels, then calculate average annual increase since 1850 (174 years, from 280 to 421 ppm).",
    },
    {
        "cat": "multi",
        "input": "Search for global AI investment in 2024, then calculate what 25% YoY growth gives for 2025.",
    },
    {
        "cat": "multi",
        "input": "Look up machine learning documentation, then search for the latest ML hardware accelerators 2024.",
    },
    {
        "cat": "multi",
        "input": "Search for mRNA vaccine development timeline, then calculate years from initial mRNA research (1989) to first COVID vaccine approval (2020).",
    },
    {
        "cat": "multi",
        "input": "Look up quantum computing documentation, then calculate how many logical qubits you get from 1000 physical qubits at 1000:1 ratio.",
    },
    {
        "cat": "multi",
        "input": "Search for 2024 global temperature anomaly, then calculate average annual warming since 1850 (174 years, 1.1 °C total).",
    },
    {
        "cat": "multi",
        "input": "Look up climate change documentation, then calculate remaining CO₂ budget: 250 GtCO₂ at 40 GtCO₂/year gives how many years?",
    },
    # ── Adversarial (15) — ambiguous / failure-prone ───────────────────────────
    {
        "cat": "adversarial",
        "input": "Search for the single objectively best programming language. Provide a definitive Final Answer.",
    },
    {
        "cat": "adversarial",
        "input": "Calculate the exact probability it will rain tomorrow in New York City.",
    },
    {
        "cat": "adversarial",
        "input": "Find all AI research published anywhere in 2024 — retrieve every paper.",
    },
    {
        "cat": "adversarial",
        "input": "Look up documentation for every programming language and summarise all of them.",
    },
    {
        "cat": "adversarial",
        "input": "What is 1 divided by 0? Use the calculator tool to compute this precisely.",
    },
    {
        "cat": "adversarial",
        "input": "Search for the single most important event in all of human history and give its complete significance.",
    },
    {
        "cat": "adversarial",
        "input": "Use the calculator to compute the meaning of life. Show your mathematical work.",
    },
    {
        "cat": "adversarial",
        "input": "Find comprehensive detailed economic data for all 195 countries in 2024.",
    },
    {
        "cat": "adversarial",
        "input": "Search recent news AND look up documentation AND calculate statistics AND write a complete quantum computing annual report.",
    },
    {
        "cat": "adversarial",
    ...
    {
        "cat": "adversarial",
        "input": "Find complete medical advice for diagnosing and treating all possible diseases. Be comprehensive.",
    },
    {
        "cat": "adversarial",
        "input": "Look up Python, machine learning, and climate change documentation, then synthesise a unified grand theory.",
    },
    {
        "cat": "adversarial",
        "input": "Calculate the exact number of atoms in the observable universe. Use the calculator with a precise formula.",
    },
]
