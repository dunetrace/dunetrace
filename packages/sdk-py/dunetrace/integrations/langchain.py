...
class DunetraceCallbackHandler(BaseCallbackHandler):  # type: ignore[misc]
        ...
        try:
            ...
            with self._lock:
                is_root = not parent_lc_id or (
                    parent_lc_id not in self._runs and
                    parent_lc_id not in self._lc_parent
                )
            ...
            self._safe_emit(EventType.RUN_STARTED, ctx, {
    ...
    def on_chain_end(self, outputs: Dict, **kwargs: Any) -> None:
        try:
            ...
            from dunetrace.models import EventType
            self._safe_emit(EventType.RUN_COMPLETED, ctx, {
    ...
    def on_chain_error(self, error: Exception, **kwargs: Any) -> None:
        try:
            ...
            from dunetrace.models import EventType
            self._safe_emit(EventType.RUN_ERRORED, ctx, {
    ...
    def on_llm_error(self, error: Exception, **kwargs: Any) -> None:
        try:
            ...
            ctx.llm_start_time = None
            from dunetrace.models import EventType
            self._safe_emit(EventType.LLM_RESPONDED, ctx, {
                "finish_reason": "error",
                "output_hash":   "",
                "output_length": 0,
                "latency_ms":    0,
    ...
    def on_retriever_start(self, serialized: Dict, query: str, **kwargs: Any) -> None:
        try:
            ...
            from dunetrace.models import EventType
            self._safe_emit(EventType.RETRIEVAL_CALLED, ctx, {
    ...
    def _sweep_stale(self) -> None:
        ...
        for root_id in stale:
            logger.warning("Dunetrace: pruning stale run %s (started >%ds ago)", root_id, _STALE_RUN_SECS)
