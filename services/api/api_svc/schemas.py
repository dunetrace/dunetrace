...
if _PYDANTIC:
    ...
    class AgentTokenStats:
        ...
        waste_by_failure_type: List[Any]
    ...
    @dataclass
    class AgentInsights:
        input_patterns: List[Any]
        signal_trends: List[Any]
        versions: List[Any]
        time_to_tool: Any
        hourly_pattern: List[Any]
        failure_rates: List[Any]
        systemic_patterns: List[Any]
        deploy_events: List[Any] = _field(default_factory=list)
