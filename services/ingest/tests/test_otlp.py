...
def test_llm_span_produces_called_and_responded():
    ...
    llm  = _span("llm1", "root", "openai.chat.completions",
                 1_100_000_000, 1_900_000_000,
                 attrs=[
...
def test_retrieval_span_produces_called_and_responded():
    root = _span("root", "", "agent", 1_000_000_000_000, 3_000_000_000_000)
    ret  = _span("r1", "root", "pinecone.query",
                 1_300_000_000_000, 1_600_000_000_000,
                 attrs=[
...
def test_lifecycle_spans_not_counted_as_steps():
    ...
    lc   = _span("lc1",  "root",  "langchain.chain.invoke",
                 1_100_000_000_000, 1_200_000_000_000)
    llm  = _span("llm1", "root",  "openai.completion",
                 1_200_000_000_000, 1_900_000_000_000,
